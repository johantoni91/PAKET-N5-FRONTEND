                                        ...
                                        <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-10">
                                            <div class="relative overflow-x-auto p-5">
                                                <div class="flex flex-row md:flex-nowrap flex-wrap gap-2">
                                                                ...
                                                                <button
                                                                    ...
                                                                    <div class="flex flex-row items-center gap-2">
                                                                        <img class="w-8 h-8 rounded-full"
                                                                            src="{{ asset('assets/images/5856.jpg') }}"
                                                                            alt="5856">
                                                                        <p
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            class="absolute w-3 h-3 right-4 rounded-full bg-green">
                                                                        </div>
                                                                    </div>
                                                                </button>
                                                            </li>
                                                    ...
                                                    <div class="flex flex-col justify-between gap-1 bg-slate-200 rounded shadow overflow-y-scroll"
                                                        style="max-height: 60dvh; width: 70%">
