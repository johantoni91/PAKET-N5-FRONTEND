...
@section('kiosk')
    <div class="relative grid grid-cols-2"
        ...
        <div class="relative cols-span-1 flex flex-col">
            <div class="flex flex-row justify-start items-center gap-2 ps-3 pt-3">
                <img src="{{ asset('assets/images/kejaksaan-logo.png') }}" class="w-12 h-12" alt="">
                <div class="flex flex-col justify-start">
                    <h1 class="font-bold text-nowrap">{{ $satker['satker_name'] }}</h1>
                    <h1 class="font-semibold" style="font-size: .6em;">{!! $satker['satker_address'] !!}</h1>
                </div>
            </div>
            <div class="absolute flex flex-col justify-center items-center h-full" style="opacity: .5; width:80%">
        ...
        <div class="cols-span-1 flex flex-col justify-center items-center">
            <div class="flex flex-row flex-wrap xl:flex-nowrap gap-10 justify-center">
                <a href="{{ route('kios.token') }}"
                    class="flex flex-col gap-2 justify-center items-center text-center rounded-full bg-green-200/50 shadow shadow-green-500 hover:bg-white hover:text-black shadow-lg"
                    ...
                    <p class="mt-auto" style="font-size: 1em;">Cetak</p>
                </a>
                <a href="#"
                    class="flex flex-col gap-2 justify-center items-center text-center rounded-full bg-green-200/50 shadow shadow-green-500 hover:bg-white hover:text-black shadow-lg"
                    style="width: 200px; height:200px;">
                    ...
                    <p class="mt-auto" style="font-size: 1em;">Kartu</p>
                </a>
                <a href="#"
                    class="flex flex-col gap-2 justify-center items-center text-center rounded-full bg-green-200/50 shadow shadow-green-500 hover:bg-white hover:text-black shadow-lg"
                    style="width: 200px; height:200px;">
                    ...
                    <p class="mt-auto" style="font-size: 1em;">Lihat</p>
                </a>
            </div>
        </div>
    </div>
