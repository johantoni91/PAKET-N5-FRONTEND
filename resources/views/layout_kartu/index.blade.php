                                    ...
                                    <div class="sm:-mx-6 lg:-mx-8">
                                        <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-10">
                                            <div class="p-4 md:p-5 space-y-4">
                                                {{-- @include('partials.modals.kartu.create') --}}
                                                        ...
                                                        <tbody>
                                                            <tr
                                                                ...
                                                                <td class="px-6 py-4 dark:text-white text-center">
                                                                    <a href="#"
                                                                        class="justify-center items-center gap-2 flex flex-row text-green-500 hover:drop-shadow-green">
                                                                ...
                                                                <td
                                                                    ...
                                                                    <div class="flex flex-row gap-3 justify-center">
                                                                        ...
                                                                        @include('partials.modals.kartu.view')
