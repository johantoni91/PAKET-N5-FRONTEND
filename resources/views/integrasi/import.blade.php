                        ...
                        <div class="w-full">
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    <h1 class="font-medium text-3xl block dark:text-slate-300/70">Integrasi Data Kepegawaian
                                    </h1>
                                    <small class="dark:text-slate-300/70"><a href="{{ route('integrasi') }}"
                                            class="text-blue dark:text-blue">Integrasi</a> /
                                        Impor</small>
                                </div>
                            </div>
                        </div>
