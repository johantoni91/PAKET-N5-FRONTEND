<div id="create" tabindex="-1"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" action="{{ route('perangkat.tm.store') }}" method="post">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        <label for="perangkat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                            alat</label>
                        <input type="text" name="perangkat" id="perangkat"
