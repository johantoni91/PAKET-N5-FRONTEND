                            ...
                            <div class="flex flex-wrap justify-between">
                                <div class="items-center ">
                                    ...
                                    <p class="ms-1 text-slate-600"> <a href="{{ route('perangkat') }}"
                                            class="text-blue-600 font-semibold">Data Perangkat </a> > Ubah Peralatan
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="grid grid-cols-1 p-4 overflow-scroll">
                                    <div class="sm:-mx-6 lg:-mx-8">
                                        <form action="{{ route('perangkat.tc.update', [$id]) }}" method="post"
                                                ...
                                                <div
                                                    ...
                                                    <div class="grid grid-cols-4 gap-4 mb-3">
                                                        <div class="text-start font-semibold">
                                                            <label
                                                                for="perangkat">{{ Illuminate\Support\Facades\Http::withToken(session('data')['token'])->get(env('API_URL', '') . '/perangkat' . '/' . $item['id_perangkat'] . '/find/tm_hardware')->json()['data']['perangkat'] }}</label>
                                                            <input type="hidden" value="{{ $item['id_perangkat'] }}"
                                                                name="id_perangkat[]">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-span-2 text-start">
                                                            <img src="{{ $item['photo'] }}"
                                                                class="w-24 h-24 rounded-lg mb-3" alt=""
                                                                id="photo{{ $item['id'] }}">
                                                            <input name="photo[]"
                                            ...
                                            <div class="flex justify-end me-10">
                                                <button type="submit"
                                                    class="focus:outline-none bg-gradient-to-r from-violet-800 to-red-500 text-white dark:bg-gradient-to-r dark:from-zinc-500 dark:to-cyan-300 dark:hover:from-cyan-300 dark:hover:to-zinc-500 dark:text-white text-sm font-medium py-1 px-3 rounded hover:from-red-500 hover:to-violet-800">Ubah</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
