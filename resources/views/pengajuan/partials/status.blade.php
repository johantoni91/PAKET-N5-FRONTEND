@if ($item['status'] == 0)
    <div class="relative mb-5 h-5 rounded-full bg-gray-200 dark:bg-slate-500">
...
@elseif($item['status'] == 3)
    <div class="relative mb-5 h-5 rounded-full bg-gray-200 dark:bg-slate-500">
        <div class="h-full animate-pulse rounded-full bg-gradient-to-r from-green-500 to-blue-500" style="width: 100%">
