...
<body>
    <a href="{{ route('layout.kartu') }}"
        class="text-white flex flex-row gap-2 items-center p-2 rounded-lg hover:bg-blue-500 hover:animate-pulse"
        style="position: fixed; z-index: 99; bottom: 2dvh; right: 3dvw;"><svg xmlns="http://www.w3.org/2000/svg"
