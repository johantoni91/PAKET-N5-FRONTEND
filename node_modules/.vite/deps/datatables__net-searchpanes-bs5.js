...
(function() {
    ...
    function() {
      function SearchPane2(paneSettings, opts, index, panesContainer, panes) {
        ...
        this.dom = {
          ...
          dtP: $$5('<table width="100%"><thead><tr><th>' + (this.s.colExists ? $$5(this.s.dt.column(this.s.index).header()).text() : this.s.customPaneSettings.header || "Custom Pane") + "</th><th/></tr></thead></table>"),
  ...
  dataTables_default.SearchPanes = SearchPanes;
  dataTable.SearchPanesST = SearchPanesST;
  dataTables_default.SearchPanesST = SearchPanesST;
  dataTable.SearchPane = SearchPane;
  dataTables_default.SearchPane = SearchPane;
  dataTable.SearchPaneViewTotal = SearchPaneViewTotal;
  dataTables_default.SearchPaneViewTotal = SearchPaneViewTotal;
  dataTable.SearchPaneCascade = SearchPaneCascade;
  dataTables_default.SearchPaneCascade = SearchPaneCascade;
  dataTable.SearchPaneCascadeViewTotal = SearchPaneCascadeViewTotal;
  dataTables_default.SearchPaneCascadeViewTotal = SearchPaneCascadeViewTotal;
  ...
  dataTables_default.ext.buttons.searchPanesClear = {
    action: function(e, dt) {
      dt.searchPanes.clearSelections();
    },
    text: "Clear Panes"
  };
  dataTables_default.ext.buttons.searchPanes = {
  ...
  function _buttonSourced(dt, node, config) {
    ...
    var panes = buttonOpts && (buttonOpts.cascadePanes || buttonOpts.viewTotal) ? new dataTables_default.SearchPanesST(dt, buttonOpts) : new dataTables_default.SearchPanes(dt, buttonOpts);
  ...
  $(document).on("preInit.dt.dtsp", function(e, settings) {
    ...
    if (settings.oInit.searchPanes || dataTables_default.defaults.searchPanes) {
  ...
  if (dataTables_default.feature) {
    dataTables_default.feature.register("searchPanes", _init);
  }
})();
